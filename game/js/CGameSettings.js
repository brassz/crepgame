function CGameSettings(){
    ...
    this._initBetMultiplier = function(){
        ...
        // Multiplicadores para as novas apostas específicas
        _aBetMultiplier["bet_4_10"] = 2;     // Paga dobrado
        _aBetMultiplier["bet_6_8"] = 0.25;   // Paga 25%
        _aBetMultiplier["bet_5_9"] = 0.5;    // Paga 50%
    ...
    this.getBetWinLoss = function(iState,iNumberPoint,szBet){
        ...
        // Nova lógica de apostas específicas (apenas para apostas manuais)
        if(szBet === "bet_4_10"){
            // 4-10: paga valor dobrado
            aDiceForWin[3] = 1;  // 4
            aDiceForWin[9] = 1;  // 10
    ...
    this.checkBetWin = function(iSumDices,iState,iAmountForBet,iNumberPoint,szBet,aDiceResult){
        ...
        // Nova lógica de apostas específicas - SIMPLIFICADA
        // Os botões agora só servem para apostar no número que será o ponto
        // O pagamento real acontece automaticamente no sistema de ponto
        
        if(szBet === "bet_4_10" || szBet === "bet_6_8" || szBet === "bet_5_9"){
            // Estas apostas não pagam através desta função
            // O pagamento é feito automaticamente no sistema de ponto
            return -1; // Não ganha nem perde através desta função
        }
