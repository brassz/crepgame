function CInterface(){
    ...
    this._init = function(){
        ...
        var iRoomButtonX = s_bMobile ? 120 : 380;
    ...
    this.refreshButtonPos = function (iNewX, iNewY) {
        ...
        if(s_bMobile){
            ...
            if (_oButRoomBronze) { _oButRoomBronze.setPosition(380 - iNewX, 40 + iNewY); }
            if (_oButRoomPrata) { _oButRoomPrata.setPosition(380 - iNewX, 85 + iNewY); }
            if (_oButRoomOuro) { _oButRoomOuro.setPosition(380 - iNewX, 130 + iNewY); }
        }
    };
