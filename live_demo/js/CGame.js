function CGame(oData){
    ...
    this._onSitDown = function(){
        ...
        // Obter mesa selecionada do localStorage ou usar bronze como padrão
        var sSelectedRoom = localStorage.getItem("selected_room") || "bronze";
        this.changeRoom(sSelectedRoom);
    };
