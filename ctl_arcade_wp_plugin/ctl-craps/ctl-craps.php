<?php
    ...
    */
    ...
    class CTLArcadeCraps{
        ...
        private $_szPluginName              = "Dados";
        private $_szAspectRatio             = "15:9";
        private $_bGameRankAvailable        = 1; // 1 yes, 0 no
        private $_szGameTags                = "3d game, dados, mesa de dados, aposta, vitória instantânea, cassino, jogo de cassino, baccara, jogatina, jogatina html5, dados html5, cassino html5, mobile, poker, sorteios";
