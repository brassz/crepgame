-- Supabase Realtime Tables for Dice Game
-- This replaces Socket.IO functionality with Supabase Realtime

-- First, create the tables before enabling realtime
...
CREATE TABLE IF NOT EXISTS public.game_moves (
    ...
    phase TEXT NOT NULL DEFAULT 'come_out', -- 'come_out' or 'point'
    result TEXT, -- 'win', 'lose', 'continue', etc.
...
-- Enable realtime for the tables (after they are created)
